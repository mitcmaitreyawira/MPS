...
export declare class DashboardsService {
    ...
    private questParticipantsService;
    private appealsService;
    private pointLogsService;
    private teacherReportsService;
    private actionPresetsService;
    private classesService;
    private auditLogsService;
    private awardsService;
    private readonly logger;
    constructor(userModel: Model<UserDocument>, questsService: QuestsService, questParticipantsService: QuestParticipantsService, appealsService: AppealsService, pointLogsService: PointLogsService, teacherReportsService: TeacherReportsService, actionPresetsService: ActionPresetsService, classesService: ClassesService, auditLogsService: AuditLogsService, awardsService: AwardsService);
    private startTimer;
